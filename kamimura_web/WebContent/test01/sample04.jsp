...
<title>java_postgerSQL管理メニュー(削除)</title>
</head>
<body>
	<menu>
	<ul>
	...
	<p class="de_p">最初に削除データを検索してください</p>
	<div class="de_kensaku">
	<form action="/kamimura_web/Sample04" method="post">
	...
	<th>商品名</th>
	<td>
	<input type="text" size="30" name="shohin_mei" placeholder="例：テーブル" readonly value=<%= sname %>>
	</td>
	</tr>
	<tr>
	<th>商品分類</th>
	<td>
	<input type="text" size="20" name="shohin_bunrui" placeholder="例：事務用品" readonly value=<%= sbunrui %>>
	</td>
	</tr>
	<tr>
	<th>販売単価</th>
	<td>
	<input type="text" size="10" name="hanbai_tanka" placeholder="例：3000" readonly value=<%= shanbai %>>
	</td>
	</tr>
	<tr>
	<th>仕入単価</th>
	<td>
	<input type="text" size="10" name="shiire_tanka" placeholder="例：2000" readonly value=<%= sshiire %>>
	</td>
	</tr>
	<tr>
	<th>登録日</th>
	<td>
	<input type="text" size="20" name="torokubi" placeholder="例：2020-01-01" readonly value=<%= storokubi %>>
	</td>
	</tr>
	<tr>
	<td class="de_bt">
